...
<style>
    ...
    /* Styles for the left container (Highcharts) */
    .left-container {
    ...
    th {
        background-color: gray; /* 調整表頭背景顏色 */
        color: gray; /* 調整表頭文字顏色 */
        font-weight: bold;
    ...
    tr:hover {
        background-color: #ecf0f1; /* 調整懸停時的背景顏色 */
    }
    ...
    .close:focus {
        ...
        /* Add your CSS styles for the table and modal */
        table {
        ...
        .table-container {
        max-height: 610px; /* 設定固定高度，根據實際需求調整 */
        ...
        .container-flex {
        display: flex;
        justify-content: space-between; /* 調整子元素之間的間距 */
    }

    /* Add your CSS styles for the left and right containers */
    .left-container,
    .right-container {
        width: 48%; /* 調整左右容器的寬度，根據實際需求調整 */
    }
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <!-- 右側放置表格 -->
            <div class="col-md-6 ight-container">
...
['cycling', 'kterry01'],
    ...
    <!-- Include your custom script for table -->
    <script>
        // Display table and other related scripts
        // ...
    </script>
@endsection
